...
`https://github.com/usercise/spelunk/releases/tag/v0.4.0`
...
```bash
# macOS Apple Silicon
https://github.com/usercise/spelunk/releases/latest/download/spelunk-v0.4.0-aarch64-apple-darwin.tar.gz

# macOS universal (x86_64 + Apple Silicon)
https://github.com/usercise/spelunk/releases/latest/download/spelunk-v0.4.0-universal-apple-darwin.tar.gz

# Linux x86_64
https://github.com/usercise/spelunk/releases/latest/download/spelunk-v0.4.0-x86_64-unknown-linux-gnu.tar.gz

# Linux ARM64
https://github.com/usercise/spelunk/releases/latest/download/spelunk-v0.4.0-aarch64-unknown-linux-gnu.tar.gz
```
